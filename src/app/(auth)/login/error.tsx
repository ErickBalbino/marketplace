      ...
      <main className="container flex min-h-dvh items-center justify-center py-12">
        <div className="w-full max-w-lg rounded-2xl border bg-white p-8 shadow-card text-center">
          ...
          <h1 className="text-2xl font-semibold tracking-tight">
            Algo deu errado ao carregar o Login
          </h1>
          ...
          <div className="mt-6 flex flex-col gap-2 sm:flex-row sm:justify-center">
            <button
              onClick={reset}
              className="inline-flex items-center justify-center gap-2 rounded-md bg-brand-800 px-4 py-2 text-sm font-medium text-white hover:bg-brand-900"
            >
              <RefreshCw size={16} />
              Tentar novamente
            </button>
